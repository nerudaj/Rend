...
TEST_CASE("[ShortcutCombo]")
{
    SECTION("Comparison")
    {
        ...
        {
            ShortcutCombo combo1 = { .key = sf::Keyboard::A };
            ShortcutCombo combo2 = { .ctrlRequired = true,
                                     .key = sf::Keyboard::A };
        ...
        {
            ShortcutCombo combo1 = { .key = sf::Keyboard::A };
            ShortcutCombo combo2 = { .shiftRequired = true,
                                     .key = sf::Keyboard::A };
        ...
        {
            ShortcutCombo combo1 = { .key = sf::Keyboard::A };
            ShortcutCombo combo2 = { .key = sf::Keyboard::B };
        ...
        {
            ShortcutCombo combo = { .shiftRequired = true,
                                    .key = sf::Keyboard::End };
        ...
        {
            ShortcutCombo combo1 = { .shiftRequired = true,
                                     .key = sf::Keyboard::M };
            ShortcutCombo combo2 = { .ctrlRequired = true,
                                     .key = sf::Keyboard::O };
        ...
        SECTION("Mixed values")
        {
            ShortcutCombo combo1 = { .key = sf::Keyboard::Left };
            ShortcutCombo combo2 = { .shiftRequired = true,
                                     .key = sf::Keyboard::T };
    ...
    SECTION("Serialization")
    {
        SECTION("Only key")
        {
            ShortcutCombo combo = { .key = sf::Keyboard::A };
        ...
        SECTION("Ctr + key")
        {
            ShortcutCombo combo = { .ctrlRequired = true,
                                    .key = sf::Keyboard::H };
            auto str = std::to_string(combo);
            REQUIRE(str == "Ctrl+H");
        }
