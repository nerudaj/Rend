...
public:
    ...
    virtual void penDragUpdate(
        const sf::Vector2i& start, const sf::Vector2i& end) final override;
...
protected:
    ...
    getObjectIndexFromMousePos(const sf::Vector2i& pos) const = 0;

    [[nodiscard]] virtual sf::Vector2i
    getPositionOfObjectWithIndex(std::size_t index) const = 0;
    ...
    virtual void
    createMoveCommand(const sf::Vector2i& src, const sf::Vector2i& dest) = 0;
