...
set ( DGM_FSM_LIB_URL "https://github.com/nerudaj/fsm-lib/releases/download/v${FSM_LIB_VERSION}/fsm-lib-v${FSM_LIB_VERSION}-Windows-MSVC-x64.zip" )
...
fetch_dependency ( FSM  ${DGM_FSM_LIB_URL} FALSE )
...
#link_directories("${FSM_FOLDER}/lib")
...
message ( "Looking for fsm-lib" )
find_library(LIB_FSM_D libfsm-d  NAMES fsm-lib-d.lib  HINTS "${FSM_FOLDER}/lib")
if ( "${LIB_FSM_D}" EQUAL "LIB_FSM_D-NOTFOUND" )
	message ( FATAL_ERROR "Cannot find fsm-lib-d.lib" )
endif()

find_library(LIB_FSM_R fsm-lib  NAMES fsm-lib.lib  HINTS "${FSM_FOLDER}/lib")
if ( "${LIB_FSM_R}" EQUAL "LIB_FSM_R-NOTFOUND" )
	message ( FATAL_ERROR "Cannot find fsm-lib.lib" )
endif()

set(LIB_FSM optimized ${LIB_FSM_R} debug ${LIB_FSM_D})
message ( "OK" )
...
add_library ( Dep_fsm INTERFACE )
target_include_directories ( Dep_fsm INTERFACE "${FSM_FOLDER}/include" )
target_link_libraries ( Dep_fsm INTERFACE ${LIB_FSM} )
